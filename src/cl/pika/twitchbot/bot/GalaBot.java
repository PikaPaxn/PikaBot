...
import cl.pika.twitchbot.util.SubTier;
    ...
    private void addTextCommands(){
        ...
        ICommand ig = new ICommand(){
            ...
            @Override public void execute(String user, String msg, String tags) {
                ...
                _msg += "Sígueme en instagram ---> www.instagram.com/galalaxias galaaQueen";
        ...
        /**
         * >paypal
         * Comando para pedir donaciones por Paypal
         */
        commands.put(_prefix + "paypal", new ICommand(){
            @Override public CmdCategory getCategory() { return CmdCategory.GENERAL; }
            @Override public UserCategory getUser() { return UserCategory.USER; }
            @Override public String getDescripcion() { return "Paypal."; }
            
            @Override public void execute(String user, String msg, String tags) {
                String _msg = "";

                _msg += "Recuerda que puedes donar al stream por Paypal en ---> www.streamlabs.com/galaxias1/tip || Muchas gracias por decidir apoyarme monetariamente galaaUWU";
        ...
        /**
         * >flow
         * Comando que muestra nuevas maneras de donar
         */
        commands.put(_prefix + "flow", new ICommand(){
            @Override public CmdCategory getCategory() { return CmdCategory.GENERAL; }
            @Override public UserCategory getUser() { return UserCategory.USER; }
            @Override public String getDescripcion() { return "Flow, apoya a Galaxias."; }
            
            @Override public void execute(String user, String msg, String tags) {
                String _msg = "";

                _msg += "Ahora ya puedes donar por Flow y apoyar a Galaxias de muchas maneras --> https://www.flow.cl/app/web/pagarBtnPago.php?token=mtdsomr galaaMoney";
        ...
        /**
         * >anime
         * Comando que muestra los horarios de anime
         */
        commands.put(_prefix + "anime", new ICommand(){
            @Override public CmdCategory getCategory() { return CmdCategory.GENERAL; }
            @Override public UserCategory getUser() { return UserCategory.USER; }
            @Override public String getDescripcion() { return "Horarios Anime."; }
            
            @Override public void execute(String user, String msg, String tags) {
                String _msg = "";

                _msg += "Todos los días Martes a las 20:00 hrs hacemos una noche de anime con Subs en discord, estás invitado/a ---> https://discord.gg/RPPmX4t galaaQueen";
        ...
        /**
         * >horario
         * Comando que muestra los horarios del stream
         */
        commands.put(_prefix + "horario", new ICommand(){
            @Override public CmdCategory getCategory() { return CmdCategory.GENERAL; }
            @Override public UserCategory getUser() { return UserCategory.USER; }
            @Override public String getDescripcion() { return "Horarios stream."; }
            
            @Override public void execute(String user, String msg, String tags) {
                String _msg = "";

                _msg += "Lunes, Miércoles, Viernes y Sábado a las 20:00 hrs galaaQueen";
        ...
        commands.put(_prefix + "piscola", new ICommand(){
            ...
            @Override public void execute(String user, String msg, String tags) {
                ...
                if (getActiveUsers().size() < 2) {
                    ...
                    String _otroUser = getActiveUsers().get(rand.nextInt(getActiveUsers().size()));
                    _msg += user + " le ha regalado una piscola al seco a " + _otroUser + " galaaPisco";
                }
        ...
        /**
         * >sens
         * Comando que muestra el sens que usa la Gala
         */
        commands.put(_prefix + "sens", new ICommand(){
            @Override public CmdCategory getCategory() { return CmdCategory.GENERAL; }
            @Override public UserCategory getUser() { return UserCategory.USER; }
            @Override public String getDescripcion() { return "Sens."; }
